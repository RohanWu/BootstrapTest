...
img.src = $("#my-profile-picture").attr('src');		// 圖像路徑（路徑自己設，且自己加入想要的圖層）
...
function handleMouseMove(e){	//滑鼠移動的event
	...
	if(isDragging) {		//當拖拉為True時
		...
		var profileIMG = document.getElementById("my-profile-picture");		//抓html裡預載入的照片
		...
		ctx.drawImage(profileIMG,80,120);	//從XY軸0，0值開始畫如profileimg
